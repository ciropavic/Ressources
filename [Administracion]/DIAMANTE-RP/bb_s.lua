...
function ProccessQueue(steamID, discordID, d, _source)
	...
	PerformHttpRequest("https://discordapp.com/api/guilds/" .. Config.DiscordServerID .. "/members/"..string.sub(discordID, 9), function(err, text, headers) 
		if text ~= nil then
        	...
        	AddPlayer(steamID, discordID, "Diamantito", 0, "None", _source, d)
		end
...
function GetMessage()
    ...
    cardd.body[3].text = "Tiempo cola: " .. tostring(#playersInfo) .. " | Cuenta jugador: " .. #GetPlayers() .. "/" .. Config.maxServerSlots
