...
Config.pinkpantherStations = {
	...
	LSPD = {
		...
		Cloakrooms = {
			vector3(-3219.0, 811.90, 8.94)
		},

		Armories = {
			vector3(-3229.3, 809.3, 8.93)        
		},

		Vehicles = {
			{
				Spawner = vector3(-3199.95, 824.09, 8.93),
				InsideShop = vector3(-3200.46, 814.79, 8.93),
				SpawnPoints = {
					{ coords = vector3(-3199.41, 810.62, 8.93), heading = 257.96, radius = 6.0 },
					{ coords = vector3(-3198.41, 810.62, 8.93), heading = 257.96, radius = 6.0 }
				}
			}
		},
...
Config.AuthorizedVehicles = {
	...
	{ model = 'kuruma2', label = 'Deportivo2', price = 10000 },
