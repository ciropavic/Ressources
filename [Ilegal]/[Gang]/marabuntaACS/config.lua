...
--marabunta Kevlar Positions:
Config.KevlarZones = {
	marabuntaKevlar = {
		Pos = {
			{x = 1444.8,  y = -1490.85, z = 63.7},    
			{x = 0,  y = 0, z = 0}
		}
	}
}

--marabunta Attachments Positions:
Config.AttachmentZones = {
	marabuntaAttachments = {
		Pos = {
			{x = 1441.47,  y = -1489.95, z = 63.7},       
			{x = 0,  y = 0, z = 0} 
		}
	}
}

-- marabunta Armory Marker Settings:
...
-- marabunta Kevlar Marker Settings:
...
-- marabunta Attachments Marker Settings:
...
-- Menu Title Labels_
Config.marabuntaArmoryTitle = "Armas"
Config.WeaponStorageTitle = "Armas"
Config.RestockWeaponTitle = "Depositar"
Config.marabuntaKevlarTitle = "Chaleco"
...
Config.NomarabuntaOnline = "Ningún oficial de policía está en línea"
...
-- Set the exact name from your jobs database for marabunta
Config.marabuntaDatabaseName = 'marabunta'

-- Set required marabunta job grade to restock weapon
