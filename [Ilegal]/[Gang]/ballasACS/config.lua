...
-- ballas Armory Positions:
Config.ArmoryZones = {
	ballasArmory = {
		Pos = {
			--{x = 707.49,  y = -791.29, z = 16.47},       
			{x = 666.46,  y = 2251.9, z = 17.47}
		}
	}
}

--ballas Kevlar Positions:
Config.KevlarZones = {
	ballasKevlar = {
		Pos = {
			{x = 671.5,  y = 2252.08, z = 17.47},    
			{x = 0,  y = 0, z = 0}
		}
	}
}

--ballas Attachments Positions:
Config.AttachmentZones = {
	ballasAttachments = {
		Pos = {
			{x = 669.19,  y = 2245.59, z = 17.47},       
			{x = 0,  y = 0, z = 0} 
		}
	}
}

-- ballas Armory Marker Settings:
...
-- ballas Attachments Marker Settings:
...
Config.NoballasOnline = "Ningún oficial de policía está en línea"
...
-- Set the exact name from your jobs database for ballas
Config.ballasDatabaseName = 'ballas'

-- Set required ballas job grade to restock weapon
