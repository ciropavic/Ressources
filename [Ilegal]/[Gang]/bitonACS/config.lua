...
-- biton Attachments Marker Settings:
...
Config.NobitonOnline = "Ningún oficial de policía está en línea"
...
-- Set the exact name from your jobs database for biton
Config.bitonDatabaseName = 'biton'

-- Set required biton job grade to restock weapon
