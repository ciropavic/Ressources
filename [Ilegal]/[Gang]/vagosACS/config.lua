...
--vagos Kevlar Positions:
Config.KevlarZones = {
	vagosKevlar = {
		Pos = {
			{x = 339.89,  y = -2014.22, z = 22.94},    
			{x = 0,  y = 0, z = 0}
		}
	}
}

--vagos Attachments Positions:
Config.AttachmentZones = {
	vagosAttachments = {
		Pos = {
			{x = 336.88,  y = -2017.72, z = 22.87},       
			{x = 0,  y = 0, z = 0} 
		}
	}
}

-- vagos Armory Marker Settings:
...
-- vagos Attachments Marker Settings:
...
Config.NovagosOnline = "Ningún oficial de policía está en línea"
...
-- Set the exact name from your jobs database for vagos
Config.vagosDatabaseName = 'vagos'

-- Set required vagos job grade to restock weapon
