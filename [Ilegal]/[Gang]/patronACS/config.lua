...
-- patron Attachments Marker Settings:
...
Config.NopatronOnline = "Ningún oficial de policía está en línea"
...
-- Set the exact name from your jobs database for patron
Config.patronDatabaseName = 'patron'

-- Set required patron job grade to restock weapon
