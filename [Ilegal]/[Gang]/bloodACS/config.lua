...
-- blood Attachments Marker Settings:
...
Config.NobloodOnline = "Ningún oficial de policía está en línea"
...
-- Set the exact name from your jobs database for blood
Config.bloodDatabaseName = 'blood'

-- Set required blood job grade to restock weapon
