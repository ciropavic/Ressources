...
--diamonblack Kevlar Positions:
Config.KevlarZones = {
	diamonblackKevlar = {
		Pos = {
			{x = 731.16,  y = -795.02, z = 18.07},    
			{x = 0,  y = 0, z = 0}
		}
	}
}

--diamonblack Attachments Positions:
Config.AttachmentZones = {
	diamonblackAttachments = {
		Pos = {
			{x = 723.99,  y = -790.31, z = 16.47},       
			{x = 0,  y = 0, z = 0} 
		}
	}
}

-- diamonblack Armory Marker Settings:
...
-- diamonblack Kevlar Marker Settings:
...
-- diamonblack Attachments Marker Settings:
...
-- Menu Title Labels_
Config.diamonblackArmoryTitle = "Armas"
Config.WeaponStorageTitle = "Armas"
Config.RestockWeaponTitle = "Depositar"
Config.diamonblackKevlarTitle = "Chaleco"
...
Config.NodiamonblackOnline = "Ningún oficial de policía está en línea"
...
-- Set the exact name from your jobs database for diamonblack
Config.diamonblackDatabaseName = 'diamonblack'

-- Set required diamonblack job grade to restock weapon
