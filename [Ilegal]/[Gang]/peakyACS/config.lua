...
-- peaky Attachments Marker Settings:
...
Config.NopeakyOnline = "Ningún oficial de policía está en línea"
...
-- Set the exact name from your jobs database for peaky
Config.peakyDatabaseName = 'peaky'

-- Set required peaky job grade to restock weapon
