Config = {
    ...
    ActionTime = 5000,   -- How many milliseconds does an action take (planting, destroying, harvesting, tending)
    ...
    Burn = { -- Burn effect when destroying a plant
        ...
        Duration    = 5000,                        -- How long should it burn, in milliseconds?
    },
    Yield = {2,6}, -- How many Items.Product does each plant yield? {5,10} means "from 5 to 10, inclusive"
