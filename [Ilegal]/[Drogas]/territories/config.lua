...
Config = {
  ...
  InfluenceTick     = 200,           -- how long between influence gain/loss tick?
  ...
  SellDrugsTimer    = 500,           -- How long does the drug deal take? (MS)
  ...
  GangJobs = {                        -- List all jobs that are able to contest for and control territories here.
    "ballas",                          -- NOTE: Don't need to include police. Thats taken from PoliceJob var above.
    "blood",
    "diamonblack",
    "marabunta",
	"peaky",
...
Territories = {
  ["Lavadero"] = {
    ...
    influence = 0.0,                                    -- The default influence for this zone.
  ...
  ["Marihuana"] = {
    ...
    areas = {
      [1] = {
        location  = vector3(1347.3,1281.75,24.45),
        width     = 390.0,
        height    = 210.0,
        heading   = 180,
        display   = 10
    ...
    blipData = {
      pos = vector3(1347.3,1281.75,24.45),
      sprite = 496,
      color = 2,
  ...
  ["Metha"] = {
    ...
    areas = {
      [1] = {
        location  = vector3(188.6, 1307.7, 14.65),
        width     = 200.0,
        height    = 280.0,
        heading   = 50,
        display   = 10
    ...
    blipData = {
      pos = vector3(188.6, 1307.7, 14.65),
      sprite = 499,
      color = 3,
    ...
    actions = {
      ...
      ["package_meth"] = {
        ...
        location    = vector3(188.6, 1309.7, 14.65),
  ...
  ["Cocaina"] = {
    ...
    areas = {
      [1] = {
        location  = vector3(-1086.11, 1981.67, 13.55),
        width     = 290.0,
        height    = 220.0,
        heading   = 50,
        display   = 10
    ...
    blipData = {
      pos = vector3(-1086.11, 1981.67, 13.55),
      sprite = 497,
      color = 0,
    ...
    actions = {
      ...
      ["process_cocaine"] = {
        ...
        location    = vector3(-1086.11, 1981.97, 13.55),
      ...
      ["package_cocaine"] = {
        ...
        location    = vector3(-1086.11, 1981.787, 13.55),
