UTK = {}
UTK.timer = 125 -- countdown to secure lock in seconds (time needed to pass to door to be closed back)
...
UTK.maxcash = 750 -- maximum amount of cash a pile can hold
UTK.mincash = 300 -- minimum amount of cash a pile holds
...
UTK.Banks = {
    F1 = {
        doors = {
            startloc = {x = 966.48, y = 1416.96, z = 22.25, h = 63.00, animcoords = {x =  966.48, y = 1416.96, z = 21.25, h = 63.60}},
           -- secondloc = {x = 964.81, y = 1416.59, z = 22.23, h = 357.91, animcoords = {x = 964.81, y = 1416.59, z = 21.23, h = 357.91}},
            --lockpick = {x = , y = , z = , h = , animcoords = {x = , y = , z = }}
        },
        prop = {
            first = {coords = vector3(0,0, 0), rot = vector3(90.0, 180.0, 21.0)},
            second = {coords = vector3(0, 0, 0), rot = vector3(90.0, 180.0, 110.0)}
        },
        trolley1 = {x = 962.4, y = 1419.33, z = 21.23, h = 359.69},
        trolley2 = {x = 964.66, y = 1419.28, z = 21.23, h =359.69},
        trolley3 = {x = 963.19, y = 1415.22, z = 21.23, h = 356.95},
        objects = {
            vector3(963.81, 1418.6, 21.23),
            vector3(964.66, 1419.28, 21.23),
            vector3(962.36, 1416.03, 21.23)
        },
        loot1 = false,
        loot2 = false,
        loot3 = false,
