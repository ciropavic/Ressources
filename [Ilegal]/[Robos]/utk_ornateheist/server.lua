...
local mincash = 1500 -- minimum amount of cash a pile holds
local maxcash = 3000 -- maximum amount of cash a pile can hold
...
local totalcash = 0
local PoliceDoors = {
    {loc = vector3(180.61, 306.31, 15.5), txtloc = vector3(180.61, 306.51, 15.5), model = "hei_v_ilev_bk_gate_pris", model2 = "hei_v_ilev_bk_gate_molten", obj = nil, obj2 = nil, locked = true},
    {loc = vector3(178.7, 310.56, 15.49), txtloc = vector3(178.7, 310.86, 15.49), model = "v_ilev_bk_door", model2 = "v_ilev_bk_door", obj = nil, obj2 = nil, locked = true},
    ...
    {loc = vector3(182.84, 302.01, 10.89), txtloc = vector3(182.84, 302.31,10.89), model = "hei_v_ilev_bk_safegate_pris", model2 = "hei_v_ilev_bk_safegate_molten", obj = nil, obj2 = nil, locked = true},
    {loc = vector3(185.07,312.42,10.89), txtloc = vector3(185.07,312.42,10.89), model = "hei_v_ilev_bk_safegate_pris", model2 = "hei_v_ilev_bk_safegate_molten", obj = nil, obj2 = nil, locked = true},
    {loc = vector3(179.37, 301.7, 11.11), txtloc = vector3(178.04, 304.87, 11.09), model = "v_ilev_bk_vaultdoor", model2 = "v_ilev_bk_vaultdoor", obj = nil, obj2 = nil, locked = true}
}
            ...
            if copcount >= mincops then
                ...
                elseif method == 2 then
                    ...
                    if item >= 1 then
                        ...
                        cb("No tienes ganzúas.")
                    end
                end
            else
                cb("Debe haber al menos "..mincops.." policía en la ciudad.")
            end
        else
            cb(math.floor((cooldown - (os.time() - lastrobbed)) / 60)..":"..math.fmod((cooldown - (os.time() - lastrobbed)), 60).." se fue hasta el próximo robo.")
        end
    else
        cb("El banco está siendo robado actualmente.")
    end
end)
