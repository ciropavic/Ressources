...
UTK = {
    doorchecks = {
        {x = 180.61, y = 306.31, z = 15.5, he = 81.733, h = GetHashKey("hei_v_ilev_bk_gate_pris"), h1 = "hei_v_ilev_bk_gate_pris", h2 = "hei_v_ilev_bk_gate_molten", status = 0},
        {x = 178.7,y = 310.56,z = 15.49, he = 340.000, h = GetHashKey("v_ilev_bk_door"), status = 0},
        {x = 178.7,y = 310.56,z = 15.49, he = 249.731, h = GetHashKey("hei_v_ilev_bk_gate2_pris"), status = 0},
        {x = 182.84, y = 302.01, z = 10.89, he = 160.278, h = GetHashKey("hei_v_ilev_bk_safegate_pris"), h1 = "hei_v_ilev_bk_safegate_pris", h2 = "hei_v_ilev_bk_safegate_molten", status = 0},
        {x = 185.07, y = 312.42, z = 10.89, he = 180.082, h = GetHashKey("hei_v_ilev_bk_safegate_pris"), h1 = "hei_v_ilev_bk_safegate_pris", h2 = "hei_v_ilev_bk_safegate_molten", status = 0},
        {x = 179.37, y = 301.7, z = 11.11, he = 160.000, h = GetHashKey("v_ilev_bk_vaultdoor"), status = 0,}
    },
    ...
    grabber= false,
    info = {},
    loudstart = {x = 182.07, y = 306.06, z = 15.5, type = "hei_v_ilev_bk_gate_pris", h = 88.733},
    ...
    card1 = {x = 182.18, y = 306.21, z = 15.5},
    card2 = {x = 252.80, y = 228.55, z = 102.50},
    hack1 = {x = 180.11, y = 300.19, z = 15.5, type = "hei_v_ilev_bk_gate2_pris", h = 257.731},
    hack2 = {x = 175.47, y = 300.12, z = 10.89},
    vault = {x = 179.37,y =  301.7,z = 11.11, type = "v_ilev_bk_vaultdoor"},
    thermal1 = {x = 182.51, y = 302.38, z = 10.89,type = "hei_v_ilev_bk_safegate_pris","hei_v_ilev_bk_safegate_molten"},
    thermal2 = {x = 184.64, y = 311.98, z = 10.89,type = "hei_v_ilev_bk_safegate_pris", "hei_v_ilev_bk_safegate_molten"},
    lockpick1 = {x = 252.82, y = 221.07, z = 101.60},
    lockpick2 = {x = 261.22, y = 215.43, z = 101.68},
    cash1 = {x = 183.68, y = 311.95, z = 10.89},
    cash2 = {x = 183.65, y = 314.47, z = 10.89},
    cash3 = {x = 185.98, y = 314.79, z = 10.89},
    gold = {x = 183.43, y = 316.34, z = 10.89},
    dia = {x = 185.58, y = 316.37, z = 10.89},
    cur = 7,
    starttimer = false,
    vaulttime = 0,
    searchlocations = {
    ...
    alarmblip,
    text = { -- Texts
        loudstart = "[~r~E~w~] Comenzar ~g~LOUD~w~ robo a banco",
        silentstart = "[~r~E~w~] Comenzar ~g~SILENT~w~ robo a banco",
        usecard = "[~r~E~w~] Usar tarjeta de identificación",
        usethermal = "[~r~E~w~] Usar carga térmica",
        usehack = "[~r~E~w~] Hackear Paneles de seguridad",
        uselockpick = "[~r~E~w~] Utilice Ganzua",
        usesearch = "[~r~E~w~] Buscar",
        lootcash= "[~r~E~w~] Saquea el carrito del dinero",
        lootgold = "[~r~E~w~] Saquea el carro de oro",
        lootdia = "[~r~E~w~] Saquea el carro de diamantes",
        card = "Usando tarjeta de identificación",
        thermal = "Plantando Carga Térmica",
        burning = "Derritiendo la cerradura",
        lockpick = "Escogiendo la cerradura",
        using = "Procesamiento de paneles",
        used = "Proceso completo.",
        stage = "Terminado.",
        search = "Buscando",
        hacking = "Hackeando",
        melted = "Cerradura de puerta derretida.",
        hacked = "Hackeo completado.",
        unlocked = "Puerta abierta.",
        nothing = "NO encontro nada.",
        found = "Encontraste la tarjeta de identificación.",
        time = "Restante: "
    }
}
UTK.searchinfo = {
                                    ...
                                    if dst <= 1 and IsControlJustReleased(0, 38) then
                                        ESX.TriggerServerCallback("utk_oh:checkItem", function(output)
                                            ...
                                            elseif not output then
                                                exports['mythic_notify']:SendAlert("error", "No tienes una USB portátil hacker.")
                                            end
                                        end, "laptop_h")
                                    end
                                end
                                ...
                                if dst <= 4 then
                                    ...
                                    if dst <= 1 and IsControlJustReleased(0, 38) then
                                        ...
                                        if output then
                                            ...
                                            self:IdCard()
                                        elseif not output then
                                            exports["mythic_notify"]:SendAlert("error", "No tienes la tarjeta de identificación.")
                                        end
                                        end, "id_card")
                                    end
                                end
                                    ...
                                    if dst <= 1 and IsControlJustReleased(0, 38) then
                                        ESX.TriggerServerCallback("utk_oh:checkItem", function(output)
                                            if output then
                                                ...
                                                self:Plant()
                                            elseif not output then
                                                exports['mythic_notify']:SendAlert("error", "No tienes cargas térmicas.")
                                            end
                                        end, "thermal_charge")
                                    end
                                end
                                        ...
                                        if dst <= 1 and IsControlJustReleased(0, 38) then
                                            ESX.TriggerServerCallback("utk_oh:checkItem", function(output)
                                                if output then
                                                    ...
                                                    self:Lockpick()
                                                elseif not output then
                                                    exports['mythic_notify']:SendAlert("error", "No tienes cargas Ganzuas.")
                                                end
                                            end, "lockpick")
                                        end
                                    end
...
function UTK:Plant()
    ...
    if self.currentplant == 0 then
        ...
        loc.z = 15.5
        loc.h = 82.48
        ptfx = vector3(182.34, 306.81, 15.5)
    ...
    elseif self.currentplant == 1 then
        ...
        loc.z = 10.89
        loc.h = 265.0
        ptfx = vector3(182.2, 302.45, 10.89)
    ...
    elseif self.currentplant == 2 then
        ...
        loc.z = 10.89
        loc.h = 357.66
        ptfx = vector3(184.68, 311.94, 10.89)
        oldmodel = "hei_v_ilev_bk_safegate_pris"
        newmodel = "hei_v_ilev_bk_safegate_molten"
        rotplus = 357.66
        method = 3
...
function UTK:Hack()
    ...
    Citizen.Wait(2000)
    Brute()
    exports["mythic_notify"]:SendAlert("éxito", "Abra Mi PC y navegue hasta HackConnect.exe")
...
function SpawnObj()
    if not UTK.enablextras then
        ...
        Citizen.Wait(100)
        Trolley1 = CreateObject(269934519, 183.64, 310.42, 9.89, 1, 0, 0)
        Trolley2 = CreateObject(269934519, 186.83, 314.9, 9.89, 1, 0, 0)
        Trolley3 = CreateObject(269934519, 183.38, 313.62, 9.89, 1, 0, 0)
    ...
    elseif UTK.enablextras then
        ...
        Trolley2 = CreateObject(269934519, 186.83, 314.9, 9.89, 1, 0, 0)
        Trolley3 = CreateObject(269934519, 183.38, 313.62, 9.89, 1, 0, 0)
        Trolley4 = CreateObject(2007413986, 183.66, 316.93, 9.89, 1, 0, 0)
        Trolley5 = CreateObject(881130828, 185.77, 316.99, 9.89, 1, 0, 0)
        local heading = GetEntityHeading(Trolley3)
...
function Loot(currentgrab)
    ...
    if currentgrab == 1 then
        Trolley = GetClosestObjectOfType(183.64, 310.42, 9.89, 1.0, 269934519, false, false, false)
    elseif currentgrab == 2 then
        Trolley = GetClosestObjectOfType(186.83, 314.9, 9.89, 1.0, 269934519, false, false, false)
    elseif currentgrab == 3 then
        Trolley = GetClosestObjectOfType(183.38, 313.62, 9.89, 1.0, 269934519, false, false, false)
    elseif currentgrab == 4 then
        Trolley = GetClosestObjectOfType(183.66, 316.93, 9.89, 1.0, 2007413986, false, false, false)
        model = "ch_prop_gold_bar_01a"
    elseif currentgrab == 5 then
        Trolley = GetClosestObjectOfType(185.77, 316.99, 9.89, 1.0, 881130828, false, false, false)
...
function Search(location)
    ...
    if UTK.searchinfo.random ~= 1 then
        ...
        exports['mythic_notify']:SendAlert("exito", UTK.text.found)
...
Citizen.CreateThread(function()
    function Initialize(scaleform)
        ...
        PushScaleformMovieFunctionParameterFloat(6.0)
        PushScaleformMovieFunctionParameterString("Nivel Off")
        PopScaleformMovieFunctionVoid()
        ...
        if HasScaleformMovieLoaded(scaleform) and UsingComputer then
            ...
            if GetScaleformMovieFunctionReturnBool(ClickReturn) then
                ...
                if program == 82 and not Hacking then
                    ...
                    PopScaleformMovieFunctionVoid()
                    Hacking = true
                    exports["mythic_notify"]:SendAlert("Exito", "Encuentra la dirección IP...")
                elseif program == 83 and not Hacking and Ipfinished then
                    ...
                    Hacking = true
                    exports["mythic_notify"]:SendAlert("Exito", "Encuentra la contraseña...")
                ...
                elseif Hacking and program == 84 then
                    ...
                    Hacking = false
                    Ipfinished = true
                    exports["mythic_notify"]:SendAlert("Exito", "Ejecuta BruteForce.exe")
                ...
                elseif Hacking and program == 86 then
                    ...
                    if UTK.hackmethod == 1 then
                        --TriggerServerEvent("utk_oh:toggleDoor", UTK.hack1.type, vector3(UTK.hack1.x, UTK.hack1.y, UTK.hack1.z), false, UTK.hack1.h)
                        TriggerServerEvent("utk_oh:policeDoor", 3, false)
                        exports['mythic_notify']:SendAlert("Exito", UTK.text.hacked)
                        UsingComputer = false
                        UTK.disableinput = false
                        UTK.hackfinish = true
                        Ipfinished = false
...
AddEventHandler("utk_oh:vaulttimer", function(method)
    if method == 1 then
        exports['mythic_notify']:SendAlert("error", "Tiene 4 minutos hasta que entre el gas tóxico.")
        UTK.starttimer = true
        UTK.vaulttime = 240
        Citizen.CreateThread(function()
            while true do
        ...
        Citizen.CreateThread(function()
            ...
            while true do
                ...
                if UTK.begingas then
                    ...
                    Gas = StartNetworkedParticleFxNonLoopedAtCoord("veh_respray_smoke", 185.77, 316.99, 10.89, 0.0, 0.0, 0.0, 0.80, false, false, false, false)
                    SetPtfxAssetNextCall("core")
                    Gas2 = StartNetworkedParticleFxNonLoopedAtCoord("veh_respray_smoke", 185.39, 301.73, 10.89, 0.0, 0.0, 0.0, 1.50, false, false, false, false)
                    SetPtfxAssetNextCall("core")
                    Gas3 = StartNetworkedParticleFxNonLoopedAtCoord("veh_respray_smoke", 184.89, 308.23, 10.89, 0.0, 0.0, 0.0, 1.50, false, false, false, false)
                    Citizen.Wait(5000)
        ...
        exports['mythic_notify']:SendAlert("error", "Tiene 90 segundos hasta que entre el gas tóxico.")
        UTK.starttimer = true
        UTK.vaulttime = 90
        Citizen.CreateThread(function()
            while true do
...
AddEventHandler("utk_oh:gas_c", function()
    Citizen.CreateThread(function()
        UTK.begingas = true
        exports["mythic_notify"]:SendAlert("error", "La puerta de la bóveda se cerrará automáticamente en 60 segundos!")
        while true do
            Citizen.Wait(1)
            if UTK.begingas then
                local playerloc = GetEntityCoords(PlayerPedId())
                local dst1 = GetDistanceBetweenCoords(playerloc, 185.07, 314.62, 10.89, true)
                local dst2 = GetDistanceBetweenCoords(playerloc, 179.79, 302.01, 10.89, true)
...
AddEventHandler("utk_oh:policenotify", function(toggle)
    ...
    if player.job.name == "police" then
        if toggle == 1 then
            exports["mythic_notify"]:SendAlert("Atencion "," Las alarmas de Pacific Standart Bank se activan!", 10000, {["background-color"] = "#CD472A", ["color"] = "#ffffff"})
...
AddEventHandler("utk_oh:ptfx_c", function(method)
    ...
    if method == 1 then
        ptfx = vector3(182.42, 306.92, 15.5)
    elseif method == 2 then
        ptfx = vector3(182.47, 302.32, 10.89)
    elseif method == 3 then
        ptfx = vector3(184.59, 311.76, 10.89)
    end
    SetPtfxAssetNextCall("scr_ornate_heist")
    local effect = StartParticleFxLoopedAtCoord("scr_heist_ornate_thermal_burn", ptfx, 0.0, 0.0, 0.0, 1.0, false, false, false, false)
    Citizen.Wait(13000)
...
AddEventHandler("utk_oh:reset", function()
    ...
    UTK.grabber = false
    UTK.doorchecks = {
        {x= 180.61, y = 306.31, z = 15.5, he = 339.733, h = GetHashKey("hei_v_ilev_bk_gate_pris"), status = 0},
        {x = 178.7,y = 310.56,z = 15.49, he = 340.000, h = GetHashKey("v_ilev_bk_door"), status = 0},
        {x = 178.7,y = 310.56,z = 15.49, he = 249.731, h = GetHashKey("hei_v_ilev_bk_gate2_pris"), status = 0},
        {x = 182.84, y = 302.01, z = 10.89, he = 160.278, h = GetHashKey("hei_v_ilev_bk_safegate_pris"), status = 0},
        {x = 185.07, y = 312.42, z = 10.89, he = 250.082, h = GetHashKey("hei_v_ilev_bk_safegate_pris"), status = 0},
        {x = 179.37, y = 301.7, z = 11.11, he = 160.000, h = GetHashKey("v_ilev_bk_vaultdoor"), status = 0}
    }
    UTK.searchlocations = {
        {coords = {x = 233.40, y = 221.53, z = 110.40}, status = false},
        ...
        for k, v in ipairs(PoliceDoors) do
            ...
            if dst <= 50 then
                if v.locked then
                    ...
                    doortext = "[~r~E~w~] Quitale el seguro a la puerta"
                    state = false
                elseif not v.locked then
                    FreezeEntityPosition(v.obj, false)
                    doortext = "[~r~E~w~] Cierra la puerta"
                    state = true
                end
                if PlayerData.job.name == "police" then
                    if dst <= 1.5 then
