					...
					if robbers[_source] then
						...
						if xPlayer then
							...
							elseif chance <= 25 and chance >= 11 then
								xPlayer.addInventoryItem('cokebrick', 5)
							elseif chance <= 50 and chance >= 26 then
								xPlayer.addInventoryItem('weedbrick', 10)
								xPlayer.addAccountMoney('black_money', 500000)
							elseif chance <= 100 and chance >= 91 then
								xPlayer.addInventoryItem('methburn', 5)
							elseif chance <= 90 and chance >= 51 then
								xPlayer.addInventoryItem('cuttertorch', 2)
								xPlayer.addInventoryItem('methbrick', 6)
							end
