...
AddEventHandler('esx_hifi:place_hifi', function()
    ...
    TriggerEvent('esx:spawnObject', 'ba_prop_battle_dj_stand')
end)
...
Citizen.CreateThread(function()
    while true do
        ...
        local object = GetClosestObjectOfType(coords, 3.0, GetHashKey('ba_prop_battle_dj_stand'), false, false, false)
