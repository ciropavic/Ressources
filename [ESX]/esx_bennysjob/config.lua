...
Config.Zones = {
	...
	BennysActions = {
		Pos   = { x = -213.86, y = -1333.32, z = 29.89 },
	...
	Garage = {
		Pos   = { x = -189.65, y = -1317.52, z = 30.89 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
	...
	VehicleSpawnPoint = {
		Pos   = { x = -215.14, y = -1296.46, z = 31.3 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1,
	},

	VehicleDeleter = {
		Pos   = { x = -219.67, y = -1293.94, z = 30.3 },
	...
	VehicleDelivery = {
		Pos   = { x = -382.925, y = -133.748, z = 37000.685 },
