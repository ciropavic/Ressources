...
Config.BotonInicioTrabajo  = "Presiona ~INPUT_CONTEXT~ para iniciar el trabajo"

Config.InicioTrabajoX = 1324.18
Config.InicioTrabajoY = 2327.11
Config.InicioTrabajoZ = 28.75
---#############################----
...
Config.BotonRecoleccion =  "Presiona ~INPUT_CONTEXT~ para Cortar madera."

Config.BlipmaderaX = -288.93
Config.BlipmaderaY = 2623.37
Config.BlipmaderaZ = 8.6
...
Config.BotonProcesamiento = "Presiona ~INPUT_CONTEXT~ Para procesar madera "

Config.ProcesamientoX     = -301.99
Config.ProcesamientoY     = 2609.16
Config.ProcesamientoZ     = 8.6
---#############################----
...
Config.BotonRefinado  = "Presiona ~INPUT_CONTEXT~ para empaquetar madera "

Config.RefinadoX      = -312.94
Config.RefinadoY      = 2609.04
Config.RefinadoZ      = 8.71
---#############################----
...
Config.BotonVenta ="Presiona ~INPUT_CONTEXT~ Para vende madera "
