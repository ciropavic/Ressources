...
Config.ActivationKey = 38
Config.ActivationKeyText = 'INPUT_CONTEXT'

Config.InitialSeconds = 150
...
Config.Hospitals = {
    {
        ...
        z = 22.14,
        spawnPoints = {
            {x = -942.0, y = 1728.87, z = 22.95},   {x = -935.47, y = 1715.47, z = 23.01},
            {x = -231.06, y = 1029.13, z = 14.7},  {x = -222.82, y =1028.05, z = 14.75},
            {x = 153.94, y = 1768.05, z = 14.48},  {x = 150.6, y = 1752.75, z = 14.65},
            {x = 480.15, y = 2510.34, z = 16.0},  {x = 478.9, y = 2499.19, z = 16.23},
            {x = 1170.17, y = 1531.81, z = 36.78},  {x = 1157.54, y = 1550.37, z = 33.95},
            {x = 1485.47, y = 974.36, z = 26.49},  {x = 1471.78, y = 968.66, z = 26.61}
        }
    }
}
