...
AddEventHandler('esx_ambulancejob:notif', function()
	...
	ReaFaite = true
	ESX.ShowAdvancedNotification('EMS INFO', 'EMS CENTRAL', 'Reanimación realizada.\n~g~150€~w~ Añadido a la caja fuerte de la empresa.\n~g~'..Nombreinter..' intervención en curso.', 'CHAR_MP_MORS_MUTUAL', 3)
end)
...
function StartDeathTimer()
	...
	Citizen.CreateThread(function()
		...
		if bleedoutTimer < 1 and IsDead then
			RemoveItemsAfterRPDeath()
			ExecuteCommand("/tp -1262.69 2114.8 23.33")
		end
	end)
end
...
function RemoveItemsAfterRPDeath()
	...
	Citizen.CreateThread(function()
		...
		ExecuteCommand("/tp -1262.69 2114.8 23.33")
		PlaySoundFrontend(-1, "1st_Person_Transition", "PLAYER_SWITCH_CUSTOM_SOUNDSET", 0)
		ESX.ShowAdvancedNotification('REANIMATION X', 'Unidad X reanimación', 'Has sido revivido por la Unidad X.', 'CHAR_CALL911', 1)
		...
		Citizen.Wait(20*500) -- Effets de la réanmation pendant 1 minute ( 60 seconde )
		Normal()
...
AddEventHandler('esx_ambulancejob:NotificationBlipsX2', function(blipId, x, y, z)
	...
	ESX.ShowAdvancedNotification('EMS INFO', 'Unidad X reanimación', 'Una persona ha sido revivida por la unidad X. \n~g~ Queda '..Nombreinter..' intervención en curso.', 'CHAR_CALL911', 1)
	...
	BeginTextCommandSetBlipName('STRING')
	AddTextComponentSubstringPlayerName('Reanimación por unidad X')
...
AddEventHandler('esx_ambulancejob:revive2', function()
	...
	Citizen.CreateThread(function()
		...
		ESX.ShowAdvancedNotification('STAFF INFO', 'STAFF ~g~REVIVIDO', 'Fuiste revivido por un staff.', 'CHAR_DEVIN', 8)
	end)
end)
