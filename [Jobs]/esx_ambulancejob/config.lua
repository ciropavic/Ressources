...
Config.EarlyRespawnFineAmount     = 1050

--No Ambulance Avaliable
Config.NoAmbulanceDeduct = 0
--Config.NoAmbulanceDeduct = 1
Config.noAmbulanceTimer = 0.1 * minute
--Config.noAmbulanceTimer = 1 * minute

Config.RespawnPoint = { coords = vector3(363.03, -592.61, 42.5), heading = 48.5 }
...
--[[
	...
	Pillbox = {
		...
		AmbulanceActions = {
			vector3(309.36, -602.57, 42.32)
		},

		Pharmacies = {
			vector3(315.03, -579.3, 90.61)
		},
		...
		FastTravels = {
			{
				...
				To = { coords = vector3(340.4, -592.71, 43.28), heading = 70.59 },
				Marker = { type = 1, x = 1.5, y = 1.5, z = 1.0, r = 102, g = 0, b = 102, a = 100, rotate = false }
			},
--[[
			{
				From = vector3(327.61, -603.17, 42.28),
		...
		FastTravelsPrompt = {
			{
				From = vector3(331.1, -595.4, 43.28),
...

			{
				...
				To = { coords = vector3(329.69, -594.52, 43.3), heading = 255.1 },
...
Config.AuthorizedVehicles = {
	...
	ambulance = {
		...
		{ model = 'dodgeEMS', label = 'Ambulance 2', price = 2000}
	},
...
Config.AuthorizedHelicopters = {
	...
	doctor = {
		{ model = 'buzzard2', label = 'Nagasaki Buzzard', price = 5000 }
	},

	chief_doctor = {
		{ model = 'buzzard2', label = 'Nagasaki Buzzard', price = 5000 },
		{ model = 'seasparrow', label = 'Sea Sparrow', price = 5000 }
	},
