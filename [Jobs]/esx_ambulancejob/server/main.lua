...
RegisterServerEvent('esx_ambulancejob:noAmbulancerevive')
AddEventHandler('esx_ambulancejob:noAmbulancerevive', function()
	local xPlayer = ESX.GetPlayerFromId(source)

	xPlayer.removeMoney(Config.NoAmbulanceDeduct)
	TriggerClientEvent('esx_ambulancejob:revive', source)
end)
