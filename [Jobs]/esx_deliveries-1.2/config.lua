...
Config.Locales = {
	...
	["start_delivery"]            = "Presione ~INPUT_CONTEXT~ para comenzar el trabajo de entrega, debe pagar el depósito de seguridad por ~g~$",
	["safe_deposit_received"]     = "El depósito seguro ha sido eliminado de su cuenta bancaria.",
	["safe_deposit_returned"]     = "El depósito seguro regresa a tu cuenta bancaria ahora",
	["safe_deposit_withheld"]     = "Mision ~r~fallida~w~, su depósito de seguridad ha sido ~r~detenido~w~.",
	...
	["finish_job"]                = "Estado de la misión: ~g~",
	["end_delivery"]              = "Presiona ~INPUT_CONTEXT~ para terminar la misión, siéntese en el automóvil o no recibirá el depósito de seguridad",
	["blip_name"]                 = "Centro de entrega",
	["dst_blip"]                  = "Entrega",
	["delivery_end"]              = "Fin de entrega",
	["delivery_failed"]           = "Pierde la caja fuerte porque su automóvil se rompe o se pierde",
	["delivery_finish"]           = "Terminas la misión de entregas",
