Locales['en'] = {
    ['route_assigned']                      = 'Usted ha sido asignado~g~%s~s~.',
    ['drive_to_first_marker']               = 'Sube al autobús y conduce hasta la primera parada en ~g~%s~.',
    ['drive_to_next_marker']                = 'Continuar hasta la siguiente parada en ~g~%s~.',
    ['no_passengers_loading_or_unloading']  = 'No hay pasajeros subiendo o bajando en esta parada',
    ['stop_continua']             = 'Continua..',
	['stop_inicio']             = 'Comienza tu Ruta ve por las paradas para recojer pasajeros NPCS o Usuarios',
	['final_estacion']             = 'Estacion de Autobus Central (Parada Min 2m)',
	['final_estacion']             = 'Estacion de Autobus Central (Parada Min 2m)',
    ['no_passengers_loading']               = 'Espere a que los pasajeros terminen de descargar. No hay pasajeros cargando en esta parada',
    ['wait_for_passengers']                 = 'Espere a que los pasajeros terminen de cargar y descargar.',

    ['route_selection_cancel']              = 'Selección de ruta de autobús cancelada.',
    ['route_selection_title']               = 'Seleciona %s linea',
    ['route_selection_random']              = 'Random',

    ['start_route']                         = '~INPUT_PICKUP~ INICIAR ~g~%s~.',
    ['passengers_loaded']                   = '~g~%d~s~ los pasajeros pagaron por esta parada. Recogido ~g~$%d.',
    ['return_to_terminal']                  = 'La ruta está terminada. Regreso a la terminal.',
    ['stop_bus']                            = 'Parada del autobús para devolverlo y cobrar.',
    ['abort_route_help']                    ='~INPUT_PICKUP~ para cancelar la ruta. Costará ~r~$%d.',
    ['get_back_in_bus']                     = 'Regrese al bus para continuar la ruta.',

    ['next_stop_label']                     = 'Siguiente parada',
    ['money_earned_label']                  = 'Dinero ganado',
    ['stops_remaining_label']               = 'Pasajeros En Bus',

    ['exploit_attempted_kick_message']      = '¡Te patearon por hacer trampa!',
    ['exploit_attempted_log_message']       = 'Bus: %s intentó explotar! (motivo: funciones de servidor llamadas cuando el trabajo no está configurado en busdriver)',

    ['abort_route']                         = 'Abortar ~g~%s',
    ['airport_route']                       = 'Ruta Distrito Sur',
    ['scenic_route']                        = 'Ruta Distrito Este',
    ['metro_route']                         = 'Ruta Distrito Centro',
    ['metro_yellow']                        = 'Metro Linea Amarilla',
    ['metro_blue']                          = 'Metro Linea Azul',
    ['metro_red']                           = 'Metro Linea Roja',
    ['metro_purple']                        = 'Metro Linea Morada',
    ['metro_orange']                        = 'Metro Centro Este',
    ['metro_black']                         = 'Metro Centro Oeste',
    ['terminal']                            = 'Terminal',
    ...
    ['stop_metro_station_arrivals']         = 'Este terminal',
