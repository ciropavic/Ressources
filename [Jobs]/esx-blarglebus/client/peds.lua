...
function Peds.CreateRandomPedInArea(coords)
    ...
    local x = coords.x + math.random() * -0 - -4
    local y = coords.y + math.random() * -0 - -4
    local heading = math.random() * 150

    local ped = CreatePed(4, modelName, x, y, coords.z, heading, true == Config.OnlyShowPedsOnClient, true)
