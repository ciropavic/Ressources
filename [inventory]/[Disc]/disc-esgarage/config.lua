...
Config.CarGarageName = "Ambulance Car Garage"
...
--Config.HeliGarageName = "Ambulance Heli Garage"
...
--Config.BoatGarageName = "Ambulance Boat Garage"
...
Config.ExtraGarageName = "Ambulance Extras"
...
Config.CarDraw3DText = "Press ~g~[E]~s~ for ~y~Ambulance Garage~s~"			-- set your desired text here
...
Config.HeliDraw3DText = "Press ~g~[E]~s~ for ~y~Ambulance Heli Garage~s~"		-- set your desired text here
...
Config.BoatDraw3DText = "Press ~g~[E]~s~ for ~y~Ambulance Boat Garage~s~"		-- set your desired text here
...
Config.AmbulanceVehicles = {
	...
	{ model = 'madabike', label = 'אופנוע מדא', price = 0 },
}

-- Ambulance Helicopters:
Config.AmbulanceHelicopters = {
	{ model = 'polmav2', label = 'Ambulance Maverick', livery = 0, price = 0 }
}
