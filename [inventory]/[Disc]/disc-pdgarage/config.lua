...
Config.PoliceVehicles = {
	{ model = 'policeb', label = 'אופנוע משטרה', price = 0 },
	{ model = 'pranger', label = 'למפקד בלבד jeep שטח', price = 0 },
	{ model = 'alstahoe', label = 'jeep ניידת משטרה', price = 0 },
	{ model = 'insurgent', label = 'טנדר משטרה', price = 0 },
	{ model = 'police', label = 'ניידת משטרה', price = 0 },
}
