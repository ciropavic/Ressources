...
$(document).ready(function () {
    ...
    $("#take").mouseenter(function () {
        ...
        $('.near-players-wrapper').find('.popup-body').html('');
        $('.near-players-wrapper').find('.popup-body').html('');
        $('.near-players-list .popup-body').append(`<div class="cashtake" data-id="cash">Dinero</div>`);
        $('.near-players-list .popup-body').append(`<div class="cashtake" data-id="black_money">Dinero Sucio</div>`);
        $('.near-players-wrapper').fadeIn();
        EndDragging();
    });
    ...
    $("#store").mouseenter(function () {
        ...
        $('.near-players-wrapper').find('.popup-body').html('');
        $('.near-players-wrapper').find('.popup-body').html('');
        $('.near-players-list .popup-body').append(`<div class="cashstore" data-id="cash">Dinero</div>`);
        $('.near-players-list .popup-body').append(`<div class="cashstore" data-id="black_money">Dinero Sucio</div>`);
        $('.near-players-wrapper').fadeIn();
        EndDragging();
    });
    ...
    $("#pay").mouseenter(function () {
        ...
        successAudio.play();
        $('.near-players-wrapper').find('.popup-body').html('');
        $('.near-players-list .popup-body').append(`<div class="cashchoice" data-id="cash">Dinero</div>`);
        $('.near-players-list .popup-body').append(`<div class="cashchoice" data-id="black_money">Dinero Sucio</div>`);
        $('.near-players-wrapper').fadeIn();
        EndDragging();
    });
        ...
        if (itemData !== undefined) {
            ...
            if (!itemData.unique) {
                if (itemData.stackable) {
                    $('.tooltip-div').find('.tooltip-uniqueness').html("No único - Stack Max (" + itemData.max + ")");
                } else {
                    $('.tooltip-div').find('.tooltip-uniqueness').html("No único - No apilable");
                }
            } else {
            ...
            if (itemData.description !== undefined) {
                $('.tooltip-div').find('.tooltip-desc').html('Descripcion: ' + itemData.description);
            } else {
                $('.tooltip-div').find('.tooltip-desc').html("Este artículo no tiene información");
            }
            ...
            if (itemData.staticMeta !== undefined || itemData.staticMeta !== "") {
                if (itemData.type === 1) {
                    $('.tooltip-div').find('.tooltip-meta').append('<div class="meta-entry"><div class="meta-key">Dueño registrado</div> : <div class="meta-val">' + itemData.staticMeta.owner + '</div></div>');
                } else if (itemData.itemId === 'license') {
                    $('.tooltip-div').find('.tooltip-meta').append('<div class="meta-entry"><div class="meta-key">Nombre</div> : <div class="meta-val">' + itemData.staticMeta.name + '</div></div>');
                    $('.tooltip-div').find('.tooltip-meta').append('<div class="meta-entry"><div class="meta-key">Emitido el</div> : <div class="meta-val">' + itemData.staticMeta.issuedDate + '</div></div>');
                    $('.tooltip-div').find('.tooltip-meta').append('<div class="meta-entry"><div class="meta-key">Altura</div> : <div class="meta-val">' + itemData.staticMeta.height + '</div></div>');
                    $('.tooltip-div').find('.tooltip-meta').append('<div class="meta-entry"><div class="meta-key">Fecha Nacimiento</div> : <div class="meta-val">' + itemData.staticMeta.dob + '</div></div>');
                    $('.tooltip-div').find('.tooltip-meta').append('<div class="meta-entry"><div class="meta-key">NºTelefono</div> : <div class="meta-val">' + itemData.staticMeta.phone + '</div></div>');
                    $('.tooltip-div').find('.tooltip-meta').append('<div class="meta-entry"><div class="meta-key">ID</div> : <div class="meta-val">' + itemData.staticMeta.id + '-' + itemData.staticMeta.user + '</div></div>');

                    if (itemData.staticMeta.endorsements !== undefined) {
                        $('.tooltip-div').find('.tooltip-meta').append('<div class="meta-entry"><div class="meta-key">Aprobación</div> : <div class="meta-val">' + itemData.staticMeta.endorsements + '</div></div>');
                    }
                } else if (itemData.itemId === 'gold') {
                    $('.tooltip-div').find('.tooltip-meta').append('<div class="meta-entry"><div class="meta-key"></div> : <div class="meta-val">Este Arma tiene un número de serie grabado en él registrado en la Reserva Federal de DiamanteRP</div></div>');
                }
            } else {
                $('.tooltip-div').find('.tooltip-meta').html("Este artículo no tiene información");
            }
            $('.tooltip-div').show();
        }
    });
...
function AttemptDropInEmptySlot(origin, destination, moveQty) {
    ...
    if (result === -1) {
        ...
        if (moveQty === item.qty) {
            ...
            InventoryLog('Empty: Moving ' + moveQty + ' ' + item.label + ' From ' + origin.data('invOwner') + ' Slot ' + item.slot + ' a ' + destination.parent().data('invOwner') + ' Slot ' + item2.slot);
        ...
        if (result === 1) {
            ...
            InventoryLog("El propietario del inventario de destino no estaba definido");
        }
    }
}
